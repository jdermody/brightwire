...
namespace BrightData.Cuda.CudaToolkit
{
    ...
    public class CudaStream : IDisposable
    {
        ...
        public CudaStream(CUStreamFlags flags)
        {
            ...
            _res = DriverAPINativeMethods.Streams.cuStreamCreate(ref _stream, flags);
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamCreate: {_res}");
        ...
        public CudaStream(int priority, CUStreamFlags flags)
        {
            ...
            _res = DriverAPINativeMethods.Streams.cuStreamCreateWithPriority(ref _stream, flags, priority);
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamCreateWithPriority: {_res}");
            if (_res != CUResult.Success) throw new CudaException(_res);
            _isOwner = true;
        }
        ...
        {
            if (fDisposing && !_disposed && _isOwner)
            {
                _res = DriverAPINativeMethods.Streams.cuStreamDestroy_v2(_stream);
                Debug.WriteLine($"{DateTime.Now:G}, cuStreamDestroy: {_res}");
                _disposed = true;
            }
            if (!fDisposing && !_disposed && _isOwner)
        ...
        public void Synchronize()
        {
            ...
            _res = DriverAPINativeMethods.Streams.cuStreamSynchronize(_stream);
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamSynchronize: {_res}");
            if (_res != CUResult.Success) throw new CudaException(_res);
        }
        ...
        {
            if (_disposed) throw new ObjectDisposedException(this.ToString());
            _res = DriverAPINativeMethods.Streams.cuStreamQuery(_stream);
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamQuery: {_res}");
            if (_res != CUResult.Success && _res != CUResult.ErrorNotReady) throw new CudaException(_res);

            if (_res == CUResult.Success) return true;
        ...
        {
            if (_disposed) throw new ObjectDisposedException(this.ToString());
            _res = DriverAPINativeMethods.Streams.cuStreamWaitEvent(_stream, cuevent, 0);
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamWaitEvent: {_res}");
            if (_res != CUResult.Success) throw new CudaException(_res);
        ...
        public void AddCallback(CUstreamCallback callback, IntPtr userData, CUStreamAddCallbackFlags flags)
        {
            ...
            _res = DriverAPINativeMethods.Streams.cuStreamAddCallback(_stream, callback, userData, flags);
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamAddCallback: {_res}");
            if (_res != CUResult.Success) throw new CudaException(_res);
        ...
        public static void AddCallbackToNullStream(CUstreamCallback callback, IntPtr userData, CUStreamAddCallbackFlags flags)
        {
            ...
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamAddCallback: {res}");
        ...
        public int GetPriority()
        {
            ...
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamGetPriority: {res}");
            if (res != CUResult.Success) throw new CudaException(res);
            return priority;
        }
        ...
        public CUStreamFlags CuStreamGetFlags()
        {
            ...
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamGetFlags: {res}");
            if (res != CUResult.Success) throw new CudaException(res);
            return flags;
        }
        ...
        public void WaitValue(CUdeviceptr addr, uint value, CUstreamWaitValue_flags flags)
        {
            ...
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamWaitValue32: {res}");
            if (res != CUResult.Success) throw new CudaException(res);
        }
        ...
        public void WaitValue(CUdeviceptr addr, ulong value, CUstreamWaitValue_flags flags)
        {
            ...
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamWaitValue64: {res}");
            if (res != CUResult.Success) throw new CudaException(res);
        }
        ...
        public void WriteValue(CUdeviceptr addr, uint value, CUstreamWriteValue_flags flags)
        {
            ...
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamWriteValue32: {res}");
            if (res != CUResult.Success) throw new CudaException(res);
        }
        ...
        public void WriteValue(CUdeviceptr addr, ulong value, CUstreamWriteValue_flags flags)
        {
            ...
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamWriteValue64: {res}");
            if (res != CUResult.Success) throw new CudaException(res);
        }
        ...
        public void CopyAttributes(CudaStream dst)
        {
            ...
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamCopyAttributes: {res}");
            if (res != CUResult.Success) throw new CudaException(res);
        }
        ...
        public CUstreamAttrValue GetAttribute(CUstreamAttrID attr)
        {
            ...
            Debug.WriteLine($"{DateTime.Now:G}, cuStreamGetAttribute: {res}");
            if (res != CUResult.Success) throw new CudaException(res);
            return value;
        }
