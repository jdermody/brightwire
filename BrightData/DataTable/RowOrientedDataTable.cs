...
namespace BrightData.DataTable
{
    ...
    //    public void ReadTyped(IEnumerable<IConsumeColumnData> consumers, uint maxRows = uint.MaxValue)
    //    {
    ...
    //                groupedData.Add(label, data = _columns.Select(c => c.ColumnType.GetHybridBufferWithMetaData(c.MetaData, Context, tempStreams))).ToArray());
